...
auto IM_MIN(T, U)(T _a, U _b) {
    return _a < _b ? _a : _b;
}

auto IM_MAX(T, U)(T _a, U _b) {
    return _a > _b ? _a : _b;
}
 ...
 * \ingroup colormodeutl */
auto imColorModeMatch(T, U)(T _cm1, U _cm2) {
    return imColorModeSpace(_cm1) == imColorModeSpace(_cm2);
}
 ...
 * \ingroup colormodeutl */
auto imColorModeHasAlpha(T)(T _cm) {
    return _cm & IM_ALPHA;
}
 ...
 * \ingroup colormodeutl */
auto imColorModeIsPacked(T)(T _cm) {
    return _cm & IM_PACKED;
}
 ...
 * \ingroup colormodeutl */
auto imColorModeIsTopDown(T)(T _cm) {
    return _cm & IM_TOPDOWN;
}
...
auto IM_BYTECROP(T)(T _v) { return (_v < 0? 0: _v > 255? 255: _v); }
auto IM_FLOATCROP(T)(T _v) { return (_v < 0? 0: _v > 1.0f? 1.0f: _v); }
auto IM_CROPMAX(T, U)(T _v, U _max) { return (_v < 0? 0: _v > _max? _max: _v); }
auto IM_CROPMINMAX(T, U, V)(T _v, U _min, V _max) { return (_v < _min? _min: _v > _max? _max: _v); }
